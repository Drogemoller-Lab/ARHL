#/bin/bash
INPUT=/home/projects/archive/previous_projects/plinkFiles/
INPUT2=/home/projects/hearing_loss/clsaARHL_SA/
...
$PLINK --bfile $INPUT/clsa_imp_v3_clean \
...
awk 'NR==1' $INPUT2/gwas/met_better_gwas.assoc.linear > $OUTPUT/met_all_chr5_50k_sumStats.txt
grep -f $OUTPUT/met_all_chr5_50k_snpId.txt $INPUT2/gwas/met_better_gwas.assoc.linear | awk '$5 == "ADD"' >> $OUTPUT/met_all_chr5_50k_sumStats.txt
